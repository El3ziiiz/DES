Public Class Form1
    ...
    Private Function Expand(ByVal r As String) As String
        Return Mid(r, 1, 8) & Mid(r, 13, 4) & Mid(r, 9, 8) & Mid(r, 1, 4) & Mid(r, 17, 8) & Mid(r, 29, 4) & Mid(r, 25, 8) & Mid(r, 17, 4)
    End Function
    Private Function XORStr(ByVal a As String, ByVal b As String) As String
        Dim r As String = ""
        For i = 1 To Len(a)
            r = r & (CInt(Mid(a, i, 1)) Xor CInt(Mid(b, i, 1)))
        Next
        Return r
    End Function
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Len(TextBox1.Text) < 8 Then
            MsgBox("Need 8+ chars plaintext!")
            Exit Sub
        End If
        Dim staticKey As String = "SECRETK"
        ...
        For i = 1 To 6
            binKey = binKey & Bin8(Asc(Mid(staticKey, i, 1)))
        Next
        ...
        For i = 1 To 64 Step 8
            cipherText = cipherText & Chr(ToInt(Mid(cipher_bin, i, 8)) Mod 95 + 32)
        Next
        Label2.Text = "Cipher: " & cipherText
        MsgBox("Cipher_Text = " & cipherText)
    End Sub
End Class